...
time_zone_path = Path("./time_zone.csv")  # 🔹 Usa './' para asegurar que Render lo encuentre

if time_zone_path.exists():
    ...
    raise FileNotFoundError(f"Archivo no encontrado: {time_zone_path}. Asegúrate de que 'timezone.csv' esté en la carpeta principal.")
